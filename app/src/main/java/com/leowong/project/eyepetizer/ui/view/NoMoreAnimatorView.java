package com.leowong.project.eyepetizer.ui.view;
...
public class NoMoreAnimatorView extends RelativeLayout {
    ...
    public NoMoreAnimatorView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NoMoreAnimatorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
