...
//        Log.d("@", "center position->" + centerPosition + "   mPositionBeforeScroll->" + mPositionBeforeScroll);
//        int maxOffset = mPositionBeforeScroll + 1;
//        int minOffset = mPositionBeforeScroll - 1;
